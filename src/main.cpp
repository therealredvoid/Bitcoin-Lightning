...
const string strMessageMagic = "Bitcoin Lightning Signed Message:\n";
        ...
        if(MasternodePayments)
        {
            ...
            if(IsProofOfStake() && pindex != NULL){
                if(pindex->GetBlockHash() == hashPrevBlock){
                    ...
                    CBitcoin_LightningcoinAddress address2(address1);
...
{
    RenameThread("Bitcoin_Lightning-loadblk");
